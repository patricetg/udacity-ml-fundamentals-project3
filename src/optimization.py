...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        # YOUR CODE HERE: (done: https://pytorch.org/docs/stable/generated/torch.optim.SGD.html#torch.optim.SGD )
        ...
        # YOUR CODE HERE: (done: https://pytorch.org/docs/stable/generated/torch.optim.Adam.html#torch.optim.Adam)
        ...
        raise ValueError(f"Optimizer {optimizer} not supported. Please use SGD or Adam")
